...
class OPTIC_dataset(data.Dataset):
    def __init__(self, root, img_list, label_list, domain_label_list, target_size=512, img_normalize=True):
        super().__init__()
        self.root = root
    ...
    def __getitem__(self, item):
        ...
        domain_label = self.domain_label_list[item]
        ...
        mask[label_npy == 0] = 2
        return img_npy, mask[np.newaxis], img_file, domain_label
