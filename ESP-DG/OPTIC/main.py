...
def main(config):
    ...
    if config.mode == 'train_DG':
        ...
        source_dataset = OPTIC_dataset(config.dataset_root, sr_img_list, sr_label_list, sr_domain_label_list,
        ...
        target_valid_dataset = OPTIC_dataset(config.dataset_root, ts_img_list, ts_label_list, ts_domain_label_list,
