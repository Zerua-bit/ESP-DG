...
class ResUnet(nn.Module):
    def __init__(self, resnet='resnet34', num_classes=1, pretrained=False, n_domains=5, domain_discriminator_flag=1, grl=1, lambd=0.25, drop_percent=0.33, filter_WRS_flag=1, recover_flag=1):
        ...
        self.DownUpAlign_3 = DownUpAlign(in_channels=128, mid_channels=32, out_channels=self.num_classes,
                                         scale_factor=16)
        self.DownUpAlign_2 = DownUpAlign(in_channels=128, mid_channels=32, out_channels=self.num_classes,
                                         scale_factor=8)
        self.DownUpAlign_1 = DownUpAlign(in_channels=128, mid_channels=32, out_channels=self.num_classes,
                                         scale_factor=4)
        self.DownUpAlign_0 = DownUpAlign(in_channels=128, mid_channels=32, out_channels=self.num_classes,
                                         scale_factor=2)
